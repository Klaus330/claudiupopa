...
let commands = {
    ...
    help: () => {
        return [
            ...
            '<span class="commad-name"  x-data @click="runCommand(`manual`)">man</span>            <span class="command-description">See the manual.</span>',
    ...
    madness: () => { 
        document.dispatchEvent(new CustomEvent('madnessModeToggle'))

        return "Toggle Madness Mode"
    }
}
